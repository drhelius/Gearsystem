...
{
    if (ImGui::BeginPopupModal("About " GS_TITLE, NULL, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ...
        ImGui::TextLinkOpenURL("https://github.com/drhelius/" GS_TITLE);
        ImGui::Text(" "); ImGui::SameLine();
