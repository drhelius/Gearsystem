...
#if defined(GS_DEBUG)
#define WINDOW_TITLE GS_TITLE " " GS_VERSION " (DEBUG)"
#else
#define WINDOW_TITLE GS_TITLE " " GS_VERSION
#endif
...
{
    Log("\n%s", GS_TITLE_ASCII);
    Log("%s %s Desktop App", GS_TITLE, GS_VERSION);
