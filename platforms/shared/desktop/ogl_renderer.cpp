...
static void init_ogl_debug(void)
{
    create_texture_2d(&ogl_renderer_emu_debug_vram_background, 256, 256, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, (GLvoid*)emu_debug_background_buffer, false);

    for (int s = 0; s < 64; s++)
    {
        create_texture_2d(&ogl_renderer_emu_debug_vram_sprites[s], 16, 16, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, (GLvoid*)emu_debug_sprite_buffers[s], false);
    }
