...
static void set_style_light(ImGuiStyle& style)
{
    ...
    const ImVec4 accent_soft = make_color(0xE6F2C5);
    const ImVec4 accent_hover = make_color(0xE2F0BD);
    const ImVec4 accent_selected = make_color(0xD3E7A6);
    const ImVec4 accent_edge = make_color(0x8DB654);
    const ImVec4 accent_ink = make_color(0x56752B);
    const ImVec4 accent_strong = make_color(0x37401C);
    const ImVec4 accent_bright = make_color(0x69B304);
    ...
    style.Colors[ImGuiCol_ResizeGripHovered] = make_color(0x8DB654, 0.80f);
    style.Colors[ImGuiCol_ResizeGripActive] = make_color(0x56752B, 0.95f);
    ...
    style.Colors[ImGuiCol_NavHighlight] = make_color(0x69B304, 0.90f);
    ...
    style.Colors[ImGuiCol_DockingPreview] = make_color(0x69B304, 0.45f);
