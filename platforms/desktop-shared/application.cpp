...
#if defined(GEARSYSTEM_DEBUG)
#define WINDOW_TITLE GEARSYSTEM_TITLE " " GEARSYSTEM_VERSION " (DEBUG)"
#else
#define WINDOW_TITLE GEARSYSTEM_TITLE " " GEARSYSTEM_VERSION
#endif
        ...
        case SDL_CONTROLLERBUTTONUP:
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                if (event->cbutton.button == config_input[i].gamepad_1)
                    ...
                    emu_key_released(pad, Key_Reset);
