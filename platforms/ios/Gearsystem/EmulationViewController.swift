...
final class EmulationViewController: UIViewController, UIAdaptivePresentationControllerDelegate {
    private var rom: Rom
    private let emulator = GearsystemEmulator()
    ...
    private var nativeScreenWidth: CGFloat = 256.0
    private var nativeScreenHeight: CGFloat = 192.0
    ...
    private func configureViews() {
        ...
        emulator.configure(
            system: AppSettings.system.rawValue,
            region: AppSettings.region.rawValue,
            mapper: AppSettings.mapper.rawValue,
            timing: AppSettings.timing.rawValue,
            overscan: AppSettings.overscan.rawValue,
            hideLeftBar: AppSettings.hideLeftBar.rawValue,
            noSpriteLimit: AppSettings.noSpriteLimitEnabled,
            glasses: AppSettings.glasses.rawValue,
            ym2413: AppSettings.ym2413.rawValue,
            psgVolume: AppSettings.psgVolume,
            fmVolume: AppSettings.fmVolume,
    ...
    private func layoutScreen() {
        ...
        if landscape {
            ...
            let right = controlsView.actionTwo.frame.minX - 12.0
    ...
    private func emulatorButton(for button: GameControllerInput.Button) -> GearsystemButton? {
        switch button {
        case .up: return .up
