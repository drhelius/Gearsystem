...
Release:        1%{?dist}
Summary:        Sega Master System / Game Gear / SG-1000 emulator

License:        GPL-3.0-or-later
URL:            https://github.com/drhelius/Gearsystem
Source0:        https://github.com/drhelius/Gearsystem/archive/refs/tags/%{version}.tar.gz
...
%description
Gearsystem is a very accurate, cross-platform Sega Master System /
Game Gear / SG-1000 emulator written in C++.

%prep
%autosetup -n Gearsystem-%{version}
...
sed -i 's|/usr/games/gearsystem|gearsystem|g' %{buildroot}%{_datadir}/applications/%{name}.desktop
