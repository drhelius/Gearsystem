...
public:
	...
	bool sample_rate( long, int msec = 0 );
	...
	size_t read_samples( blip_sample_t*, size_t );
...
private:
	...
	void mix_stereo( blip_sample_t*, size_t );
	void mix_mono( blip_sample_t*, size_t );
};
	...
	inline size_t Stereo_Buffer::samples_avail() const {
