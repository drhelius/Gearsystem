...
const GS_GameDBEntry kGameDatabase[] =
{
    ...
    {0xa2f9c7af, GS_DB_DEFAULT_MAPPER, false, true, false, "Olympic Gold [v0] [SMS-GG]"},
    {0x3382d73f, GS_DB_DEFAULT_MAPPER, false, true, false, "Olympic Gold [v0] [SMS-GG]"},
    {0x1d93246e, GS_DB_DEFAULT_MAPPER, false, true, false, "Olympic Gold [v1] [SMS-GG]"},
    {0xf037ec00, GS_DB_DEFAULT_MAPPER, false, true, false, "Out Run Europa [SMS-GG]"},
    ...
    {0x311d2863, GS_DB_DEFAULT_MAPPER, false, true, false, "Prince of Persia [SMS-GG]"},
    {0x45f058d6, GS_DB_DEFAULT_MAPPER, false, true, false, "Prince of Persia [SMS-GG]"},
