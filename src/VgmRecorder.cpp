...
void VgmRecorder::Start(const char* file_path, int clock_rate, bool is_pal, bool has_ym2413, const VgmMetadata& metadata)
{
    if (m_bRecording)
    {
        Stop();
...
void VgmRecorder::Stop()
{
    ...
    if (file.is_open())
    {
        ...
        u32 gd3_offset = 256 + (u32)m_CommandBuffer.size();
