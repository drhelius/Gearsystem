...
#define GS_CYCLES_PER_LINE_NTSC 227
#define GS_CYCLES_PER_LINE_LEFT_NTSC 7
#define GS_CYCLES_ADJUSTMENT_LINE_NTSC 10
#define GS_HBLANK_CYCLES_NTSC 36

#define GS_MASTER_CLOCK_PAL 3546895
#define GS_LINES_PER_FRAME_PAL 313
#define GS_FRAMES_PER_SECOND_PAL 50
#define GS_CYCLES_PER_LINE_PAL 226
#define GS_CYCLES_PER_LINE_LEFT_PAL 3
#define GS_CYCLES_ADJUSTMENT_LINE_PAL 5
#define GS_HBLANK_CYCLES_PAL 35
